...
export default class ShowArticleList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],//列表数据
    ...
    componentDidMount(){
        axios.post("/Api/article/getAllArticle")//获取所有文章
            .then((res)=>{
    ...
    render() {
        ...
        const columns = [
            ...
            {
                title: <Link to="/article/edit"><Button  type="primary"> <PlusOutlined></PlusOutlined> 添加 </Button></Link>,
                key: 'action',
